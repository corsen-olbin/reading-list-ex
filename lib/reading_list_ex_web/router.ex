defmodule ReadingListExWeb.Router do
  use ReadingListExWeb, :router

  import ReadingListExWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {ReadingListExWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: ReadingListExWeb.Telemetry
    end
  end
